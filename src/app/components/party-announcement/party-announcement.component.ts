    ...
    switch (true) {
      case event.includes('dragon'):
        this.addAnnouncement(
          '⚔️ The party prepares for battle with the dragon!' // Add a dragon-related announcement
        );
        break;
      case event.includes('treasure'):
        this.addAnnouncement('💎 The party finds treasure and celebrates!'); // Add a treasure-related announcement
        break;
      case event.includes('door'):
        this.addAnnouncement(
          '🚪 The party cautiously opens a mysterious door.' // Add a door-related announcement
        );
        break;
      default:
        this.addAnnouncement(`🔮 A mysterious event occurs: ${event}`); // For all other events, provide a generic message
        break;
    }
  }
